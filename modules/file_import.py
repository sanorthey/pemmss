...
def import_projects(f, path, copy_path=None, log_path=None):
    ...
    if log_path is not None:
        ...
        export_log(str(no_remaining_resource) + ' : remaining_resource. Remaining resource generated using region-deposit type specific size models.'+str(f['size_model']), output_path=log_path)
