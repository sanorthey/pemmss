...
def import_projects(f, path, constants, copy_path=None, log_path=None):
    ...
    if log_path is not None:
        ...
        export_log(str(no_latitude) + ' : latitude. Missing regions selected randomly from weighted options.',output_path=log_path)
        export_log(str(no_longitude) + ' : longitude. Missing regions selected randomly from weighted options.',output_path=log_path)
...
#  TODO: create import_shapefile() for regional mappings and constraining coordinate generation